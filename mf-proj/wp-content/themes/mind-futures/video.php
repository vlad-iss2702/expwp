    ...
    <div class="services">
            <div class="container">
                ...
                <div class="services-info">
                    <p>MIND FUTURES предлагает услуги по съемке фото и видео материалов для вашей организации.</p>
                    <p>Подробное описание услуг можно найти в предложениях ниже.</p>
                </div>
                <?php elseif(( WPGlobus::Config()->language == "kz" )) :?>
                    <div class="main-title">
                    <h2>Фото және видео түсіру</h2>
                </div>
                <div class="services-info">
                    <p>MIND FUTURES сіздің ұйымыңыз үшін фото- және бейнематериалдарды түсіру қызметін ұсынады.</p>
