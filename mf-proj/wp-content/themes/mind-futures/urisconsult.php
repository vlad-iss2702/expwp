    ...
    <div class="services">
            ...
            <?php if( WPGlobus::Config()->language == WPGlobus::Config()->default_language ): ?>
                ...
                <div class="services-info">
                    <p>MIND FUTURES предлагает услуги по обеспечению юридической безопасности деятельности вашей компании.</p>
                    <p>Подробное описание услуг можно найти в предложениях ниже.</p>
                </div>
                <?php elseif(( WPGlobus::Config()->language == "kz" )) :?>
                <div class="main-title">
                    <h2>Заңгерге кеңес беру.</h2>
                </div>
                <div class="services-info">
                    <p>MIND FUTURES Сіздің компанияңыздың қызметін заңды қауіпсіздікпен қамтамасыз ету бойынша қызметтер ұсынады.</p>
                    <p>Қызмет жайлы толық ақпаратты төмендегі ұсынымдардан таба аласыз.</p>
                </div>
                <?php endif; ?>
