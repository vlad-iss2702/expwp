<?php
/*
Template Name: Переводы и визовая поддержка
*/
?>
<?php get_header(); ?>
<main>
    ...
    <div class="services">
            <div class="container">
                ...
                <div class="main-title">
                    <h2>Услуги переводов а также визовая поддержка.</h2>
                </div>
                <div class="services-info">
                    <p>MIND FUTURES предлагает услуги профессионального перевода документов и текстов любой сложности, а также помощь в получении визы в любую страну миру.</p>
                    <p>Подробное описание услуг можно найти в предложениях ниже.</p>
                </div>
                <?php elseif(( WPGlobus::Config()->language == "kz" )) :?>
                <div class="main-title">
                    <h2>Аударма қызметі және визалық қолдау.</h2>
                </div>
                <div class="services-info">
                    <p>АҚЫЛ БОЛАШАҚТАР кез келген құрделіліктегі құжаттар мен мәтіндердин кесіби аудармасын, сонымен қатар әлемнің кез келген елине виза алуга көмектесуди сынады.</p>
                    <p>Толық ақпаратты төмендегі ұсынымдардан ала аласыз.</p>
                </div>
                <?php endif; ?>
