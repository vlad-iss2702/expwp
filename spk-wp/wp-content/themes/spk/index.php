...
<section class="vk-content">
    ...
    <div class="home-builder-image-gallery t-gallery">
        <div class="container">            
            <div class="row">
                <div class="vk-slider vk-slick-slider vk-slider-circle" data-slick='{"slidesToShow": 5}'>
                    <div class="item col-md-3">
                        <div class="vk-img-frame partners_modern" style="">
                            <a target="_blank" href="https://atameken.kz/"><img src="<?php echo bloginfo('template_url'); ?>/assets/images/atameken_logo-1.png"></a>
                        </div>
                    </div>

                    <div class="item col-md-3">
                        <div class="vk-img-frame partners_modern">
                            <a target="_blank" href="https://invest.gov.kz/ru/"><img src="<?php echo bloginfo('template_url'); ?>/assets/images/kazahinvset_logo.png"></a>
                        </div>
                    </div>

                    <div class="item col-md-3">
                        <div class="vk-img-frame partners_modern">
                            <a target="_blank" href="https://www.hevelsolar.com/kz/"><img src="<?php echo bloginfo('template_url'); ?>/assets/images/hevel_logo.png"></a>
                        </div>
                    </div>

                    <div class="item col-md-3">
                        <div class="vk-img-frame partners_modern">
                            <a target="_blank" href="https://highvill.kz/"><img src="<?php echo bloginfo('template_url'); ?>/assets/images/highvill_logo.png"></a>
                        </div>
                    </div>

                    <div class="item col-md-3">
                        <div class="vk-img-frame partners_modern">
                            <a target="_blank" href="https://bi.group/ru/"><img src="<?php echo bloginfo('template_url'); ?>/assets/images/bigroup_logo.png"></a>
                        </div>
                    </div>
...
<!--                    </div>-->
                    ...
                    <div class="item col-md-3">
                        <div class="vk-img-frame partners_modern">
                            <a target="_blank" href="https://www.damu.kz/"><img src="<?php echo bloginfo('template_url'); ?>/assets/images/damu_logo.png"></a>
                        </div>
                    </div>
                </div>
            </div>
