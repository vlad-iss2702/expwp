...
<div class="vk-banner vk-background-image-3">
    ...
    <div class="container wrapper">
        <div class="page-heading">
            44 МНОГОЭТАЖНЫХ ДОМА СТРОИТ СПК «SHYMKENT»
        </div>
    </div>
</div>
<!--./vk-banner-->
...
<div class="vk-breadcrumb">
            <nav class="container">
                <ul>
                    ...
                    <li class="active">44 многоэтажных дома строит СПК «Shymkent»</li>
                </ul>
            </nav>
        </div>
<!--./vk-breadcrumb-->    
                                ...
                                <div class="col-md-9">
                                    <div class="blog-content">
                                        <div class="vk-img-frame">
                                            <img src="<?php echo bloginfo('template_url'); ?>/assets/images/blog-list/blog-list-1.jpg" alt="">
                                        </div>
                                        <h4 class="vk-text-uppercase">44 многоэтажных дома строит СПК «Shymkent»</h4>
                                        <div class="info">
                                            <ul class="vk-list">
                                                <li class="vk-text-capitalize">Категории:<span>&nbsp; Предпринимателю </span></li>
                                                <li class="vk-text-capitalize">Дата:<span>&nbsp; 11 Января, 2020 </span></li>
                                            </ul>
                                        </div>
                                        <div class="content">
                                            <p>Социально-предпринимателькая корпорация приступила к участию в реализации жилищной программы «7-20-25» в Шымкенте.</p>
                                            <p>Как сообщают в пресс-службе акима города, в этом году планируется возвести 146 тысяч квадратных метров жилья, из них в рамках программы «7-20-25» 24 дома, или 1016 квартир. Также за счет бюджетных средств ведется строительство 20 жилых домов на 1213 квартир. Кроме того, будут построены пристройки к многоэтажным жилым домам, социальные, бытовые, торговые и развлекательные центры.</p>
                                            <p>Дома строятся в микрорайонах «Туран», «Асар-2», «Шымкент сити» и «Шыгыс», в АДЦ и по улице Водопьянова. К концу июня 24 из этих домов будут сданы в эксплуатацию, 27 - до конца года. Остальные три жилых домов будут готовы в следующем году.</p>
                                            <p>Один квадратный метр в таких квартирах будет стоить от 180 000 до 211 000 тенге. Первоначальный взнос составляет 20% от стоимости выбранной квартиры, остальные средства могут быть выданы через банки по программе «7-20-25» под 7% на срок до 25 лет.</p>
                                        </div>
                                        <div class="share">
