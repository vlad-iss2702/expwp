    ...
    <main>
        <div class="info">
            <div class="container">
                <div class="info__tab">
                    <ul>
                        <li><a class="active" href="https://www.rcmz49.ru/media/anounce/">Анонсы</a></li>
                            ...
                            if ( $MY_QUERY->have_posts() ) :
                                while ( $MY_QUERY->have_posts() ) : $MY_QUERY->the_post(); ?>
                                    <div class="col-12 col-md-6 col-lg-4">
                                        <div class="main__announce mb-3"> <a href="<?php the_permalink(); ?>" class="main__announce_img text-center" style="background-image:url(<?php the_field('anounce__images'); ?>"></a>
